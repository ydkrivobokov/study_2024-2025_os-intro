...
![Установка необходимого ПО](image/1.jpg){#fig:001 width=70%}
...
![Конфигурация package.json](image/4.jpg){#fig:004 width=70%}

Выполняю команды. (рис. -@fig:005)

![ГИТФЛОУ ИНИТ](image/5.jpg){#fig:005 width=70%}

Разбираюсь с ветками. (рис. -@fig:006)

![Ветки](image/6.jpg){#fig:006 width=70%}
...
![Загрузка релиза на github](image/7.jpg){#fig:007 width=70%}

Добавляю ченджлог. (рис. -@fig:008)

![Ченджлог](image/8.jpg){#fig:008 width=70%}

Отправляю на гитхаб. (рис. -@fig:009)

![Конец работы](image/9.jpg){#fig:009 width=70%}
