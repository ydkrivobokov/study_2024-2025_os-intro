...
![Конфиг](image/1.jpg){#fig:001 width=70%}

Сгенерировал ключ (рис. -@fig:002)

![ключ](image/2.jpg){#fig:002 width=70%}

Ввел публичный ключ в гитхаб (рис. -@fig:003)

![ключ в гх](image/3.jpg){#fig:003 width=70%}

Авторизация через gh (рис. -@fig:004)

![гх авторизация](image/4.jpg){#fig:004 width=70%}

Создал директорию (рис. -@fig:005)

![директория](image/5.jpg){#fig:005 width=70%}

Установил ос-интро и отправил на сервер (рис. -@fig:006)

![мейк директори](image/6.jpg){#fig:006 width=70%}
