...
![Редактирование отчета](image/1.jpg){#fig:001 width=70%}

Указываю основную информацию о лабораторной работе. (рис. -@fig:002)

![Заполнение основной информации](image/2.jpg){#fig:002 width=70%}

Заполняю ход работы. (рис. -@fig:003)

![Цель работы, задание и теоретическое введение](image/3.jpg){#fig:003 width=70%}

Демонстрирую как выглядит отчет на ГИТХАБ. (рис. -@fig:004)

![Выполнение отчета по лабораторной работе](image/4.jpg){#fig:004 width=70%}
